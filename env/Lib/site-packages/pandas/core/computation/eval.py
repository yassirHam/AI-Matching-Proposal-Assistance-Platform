...
def eval(
    expr: str | BinOp,  # we leave BinOp out of the docstr bc it isn't for models
    parser: str = "pandas",
    ...
    level : int, optional
        ...
        scope. Most models will **not** need to change this parameter.
    ...
    if isinstance(expr, str):
        ...
        # ops.BinOp; for internal compat, not intended to be passed by models
        exprs = [expr]
