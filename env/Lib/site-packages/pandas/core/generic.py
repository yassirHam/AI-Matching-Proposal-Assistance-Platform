...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def to_sql(
        ...
        >>> df.to_sql(name='models', con=engine)
        3
        >>> from sqlalchemy import text
        >>> with engine.connect() as conn:
        ...    conn.execute(text("SELECT * FROM models")).fetchall()
        ...
        ...     df1.to_sql(name='models', con=connection, if_exists='append')
        2
        ...
        >>> df2.to_sql(name='models', con=engine, if_exists='append')
        2
        >>> with engine.connect() as conn:
        ...    conn.execute(text("SELECT * FROM models")).fetchall()
        [(0, 'User 1'), (1, 'User 2'), (2, 'User 3'),
        ...
        >>> df2.to_sql(name='models', con=engine, if_exists='replace',
        ...            index_label='id')
        2
        >>> with engine.connect() as conn:
        ...    conn.execute(text("SELECT * FROM models")).fetchall()
    ...
    def to_latex(
        ...
        to function. It is advised that models switch to using Styler, since that
