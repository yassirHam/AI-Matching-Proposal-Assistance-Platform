...
class MPLPlot(ABC):
    ...
    def __init__(
        ...
        **kwds,
        ...
        # if models assign an empty list or tuple, raise `ValueError`
    ...
    def _validate_sharex(sharex: bool | None, ax, by) -> bool:
        if sharex is None:
            ...
            if ax is None and by is None:  # pylint: disable=simplifiable-if-statement
                ...
                # if we get an axis, the models should do the visibility
                # setting...
                sharex = False
    ...
    def _adorn_subplots(self, fig: Figure) -> None:
        ...
        for ax in self.axes:
            ...
            # GH9093, currently Pandas does not show ylabel, so if models provide
